...
| Real-device debug security boundary | `:twinotify-core:connectedDebugAndroidTest` for `E2eControlSecurityTest` | 15 tests finished; `BUILD SUCCESSFUL` | `.omo/evidence/task-8/green-android-security-instrumentation.log` |
