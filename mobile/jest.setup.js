...
const mockTwinotifyCore = {
  ...
  getPeerStatus: jest.fn(async () => ({ paired: false })),
  getPeerLinks: jest.fn(async () => []),
  startOfflinePairingForPeer: jest.fn(),
  joinOfflinePairingForPeer: jest.fn(),
  getPeerConfiguration: jest.fn(async () => ({ relayUrl: null, preferLan: true })),
  getBluetoothRouteSettingsForPeer: jest.fn(async () => ({ associated: false, enabled: false })),
  startBluetoothAssociationForPeer: jest.fn(async () => {}),
  setBluetoothRouteEnabledForPeer: jest.fn(async () => {}),
  removeBluetoothAssociationForPeer: jest.fn(async () => {}),
  attachRelayToPeer: jest.fn(async () => {}),
  detachRelayFromPeer: jest.fn(async () => {}),
  removePeer: jest.fn(async () => ({ completed: true })),
  ...
  getBluetoothRoutePermissionAsync: jest.fn(async () => ({
    status: 'undetermined', granted: false, canAskAgain: true, expires: 'never',
  })),
  ...
  setBluetoothRouteEnabled: jest.fn(async () => false),
  removeBluetoothAssociation: jest.fn(async () => {}),
  ...
  getRepeatProtectionSettings: jest.fn(async () => ({ enabled: true, blockedCount: 0 })),
  setRepeatProtectionEnabled: jest.fn(async () => {}),
  restoreRepeatBlockedNotifications: jest.fn(async () => {}),
...
global.__RESET_OFFLINE_TEST_STATE__ = () => {
  ...
  mockTwinotifyCore.getBluetoothRoutePermissionAsync.mockResolvedValue({
    status: 'undetermined', granted: false, canAskAgain: true, expires: 'never',
  });
  mockTwinotifyCore.requestBluetoothRoutePermissionAsync.mockResolvedValue({
    status: 'granted', granted: true, canAskAgain: true, expires: 'never',
  });
  mockTwinotifyCore.startBluetoothAssociation.mockResolvedValue({ associated: false });
